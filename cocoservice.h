...
class CocoService : public QJsonRpcService
{
    Q_OBJECT
    Q_CLASSINFO("serviceName", "coco")
public:
    CocoService(QObject *parent = 0);
...
public Q_SLOTS:
    ...
    QString compileArduinoScript(const QString &code);
    QString uploadArduinoScript(const QString &code);
